...
export class DialogoInformacionComponent implements OnInit {
  ...
  tecnicosData: Tecnico[] = [
    /*{ id: 1, id_ztt: 2, nempleado: "AP123", nombre: "nombre tecnico 1", tipo: 1, consecutivo: 1 },
    { id: 2, id_ztt: 2, nempleado: "AP456", nombre: "nombre tecnico 2", tipo: 0, consecutivo: 2 },
    { id: 3, id_ztt: 2, nempleado: "AP789", nombre: "nombre tecnico 3", tipo: 0, consecutivo: 3 },
    { id: 4, id_ztt: 2, nempleado: "AP321", nombre: "nombre tecnico 4", tipo: 0, consecutivo: 4 },*/
  ];
  docsumentosData: Documento[] = [];
  mensajesData: Mensaje[] = [];
  serviciosList: any[] = [
    /*{id: 1, codigo: '111111111', concepto: 'descripción de gasto', cantidad: 5, precio: 100},
    {id: 2, codigo: '222222222', concepto: 'descripción de gasto', cantidad: 5, precio: 100},
    {id: 3, codigo: '333333333', concepto: 'descripción de gasto', cantidad: 5, precio: 100},
    {id: 4, codigo: '444444444', concepto: 'descripción de gasto', cantidad: 5, precio: 100},*/
  ];
  ...
  dialogoTecnicos = (titulo?: string, item: any = null) => {
    const _dialogRef = this._dialog.open(DialogoAdminTecnicosComponent, {
      ...
      data: { 
        ...
        zona_id: this.datosFolio.zona_id, 
        datos: this.dataTecnicos.filteredData
      }
    })
  ...
  addServicios = () => {
    ...
    //  console.log("Servicios", res);
      if (res.length) {
    //    console.log("Servicios agregados: ", res);
        let list: any[];
  ...
  ActionPost = (item: any, url: string, tipo: number = 0, msg: string = "") => {
    if(this.dataSourceServ.data== null)
    {
      this.dataSourceServ.data = [];
    } 
    /*
    if(this.dataSourceServ.data.length == 0) {
